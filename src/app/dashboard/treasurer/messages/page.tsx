...
import { MessageSquare, User, Clock, Reply, DollarSign } from "lucide-react";
...
export default function TreasurerMessagesPage() {
    const [messages, setMessages] = useState<Message[]>([
        {
            id: 1,
            from: "Ahmad Supriyadi (Wali Siti Aminah)",
            subject: "Pertanyaan tentang pembayaran SPP",
            message: "Selamat pagi, saya ingin menanyakan tentang detail pembayaran SPP bulan ini dan apakah ada cicilan?",
            date: "2023-11-20 10:00",
            topic: "Keuangan",
            status: "replied",
            reply: "Selamat pagi Pak Ahmad. Pembayaran SPP untuk bulan ini sebesar Rp 750.000. Kami menyediakan fasilitas cicilan 2x. Silakan hubungi kami untuk detailnya.",
            replyDate: "2023-11-20 14:30"
        },
        {
            id: 2,
            from: "Dewi Kartika (Wali Budi Santoso)",
            subject: "Status pembayaran anak",
            message: "Bu, saya ingin mengecek status pembayaran anak saya untuk bulan November. Apakah sudah tercatat?",
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Komunikasi tentang keuangan dan pembayaran</p>
            </div>
